...
public class MainActivity extends AppCompatActivity {
    ...
    //ip : 본인
   // String urlAddr = "http://192.168.42.130:8080/test/recyclercardwebview.json";
    String urlAddr = "http://192.168.35.230:8080/test/recyclercardwebview.json";
    Button button;

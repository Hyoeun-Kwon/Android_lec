...
public class NetworkTask2 extends AsyncTask<Integer, String, Integer> {
    ...
    public NetworkTask2(Context context, ImageView imageView, String devicePath, String mAddr) {

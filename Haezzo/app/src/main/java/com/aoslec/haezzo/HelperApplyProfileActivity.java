...
public class HelperApplyProfileActivity extends AppCompatActivity {
    ...
    static public Activity activityProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityProfile = HelperApplyProfileActivity.this;
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btn_helper_apply_profile_ok:
                    Intent intent = new Intent(HelperApplyProfileActivity.this, HelperApplyProfileCheckActivity.class);

...
public class MyHaezzoListNetworkTask extends AsyncTask<Integer, String, Object> {
    ...
    // Constructor
    public MyHaezzoListNetworkTask(Context context, String mAddr, String where) {
        this.context = context;
        this.mAddr = mAddr;
        this.myHaezzoListBeans = new ArrayList<MyHaezzoListBean>();
        this.where = where;
    } // constructor
    ...
    protected Object doInBackground(Integer... integers) {
        ...
        if(where.equals("select")){
            ...
            Log.v("Message", "  - doIn return workbooks : " + myHaezzoListBeans);
            return myHaezzoListBeans; // select는 엄청 많은 값이 들어올거임
        }else{
    ...
    private void parserSelect(String str){
        ...
        try{
            ...
            for(int i=0; i<jsonArray.length(); i++){
                ...
                //어레이에 있는거 뽑아와서 빈
                MyHaezzoListBean bean = new MyHaezzoListBean(dnumber, ddate, dmoney, dproduct, dplace, dstatus, dimage, unickname);
                myHaezzoListBeans.add(bean);
